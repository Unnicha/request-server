<?php
	...
	class Pengiriman_data_perpajakan extends CI_Controller {
		...
		public function detail() {
			...
			$data['detail']		= $isi;
			$data['badge']		= $add;
			$data['link']		= 'klien/pengiriman_data_perpajakan/detail_pengiriman/';
		...
		public function detail_pengiriman($id_data) {
			...
			$data['back']		= 'klien/pengiriman_data_perpajakan';
			...
			if($this->form_validation->run() == FALSE) {
				$this->libtemplate->main('klien/pengiriman_perpajakan/detail', $data);
			} else {
				...
				redirect('klien/pengiriman_data_perpajakan/detail/'.$id_data);
			}
		}
	}
?>
...
>>>>>>> 71b3ac856dc6eb0d4274e4826fabc8425989f9c5
			...
			$this->libtemplate->main('admin/pengiriman_lainnya/tampil', $data);
		}
...
>>>>>>> 71b3ac856dc6eb0d4274e4826fabc8425989f9c5
			...
			$data['detail']		= $isi;
			$data['badge']		= $add;
			$data['link']		= 'admin/pengiriman/pengiriman_data_lainnya/detail/';
			
			$this->load->view('admin/pengiriman_lainnya/detail', $data);
		}
...
>>>>>>> 71b3ac856dc6eb0d4274e4826fabc8425989f9c5
			...
			$this->libtemplate->main('admin/pengiriman_lainnya/rincian', $data);
		}
...
<<<<<<< HEAD
		...
		// }
=======
		// 	$this->M_Pengiriman_lainnya->konfirmasi($_REQUEST['id'], $_REQUEST['stat']);
		// 	$msg = $_REQUEST['stat'] == 'yes' ? 'Data berhasil dikonfirmasi!' : 'Konfirmasi berhasil dibatalkan!';
		// 	$this->session->set_flashdata('notification', $msg);
		// }

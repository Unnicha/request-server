	...
	class Pengiriman_data_lainnya extends CI_Controller {
		...
		public function page() {
			...
			foreach($pengiriman as $k) {
				...
				if($k['pembetulan'] == 0) {
					$btn .= '
						<a href="pengiriman_data_lainnya/pembetulan/'.$k['id_permintaan'].'" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="bottom" title="Kirim Revisi">
		...
		public function detail() {
			...
			$this->load->view('klien/pengiriman_lainnya/detail_pengiriman', $data);
		}
	}
?>
	...
	<div class="sidebar-sticky pt-md-1 pt-sm-1 pb-5">
		<div class="accordion" id="accordion">
			...
			<ul class="nav flex-column mt-0">
				...
				<div class="collapse accordion-submenu" id="menu1" aria-labelledby="headingOne" data-parent="#accordion">
			...
			<ul class="nav flex-column mt-0">
				...
				<div class="collapse accordion-submenu" id="menu2" aria-labelledby="headingTwo" data-parent="#accordion">
			...
			<ul class="nav flex-column mt-0">
				...
				<div class="collapse accordion-submenu" id="menu3" aria-labelledby="headingThree" data-parent="#accordion">
			...
			<ul class="nav flex-column mt-0">
				...
				<div class="collapse accordion-submenu" id="menu4" aria-labelledby="headingFour" data-parent="#accordion">

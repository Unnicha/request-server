		...
		<tbody class="text-center">
			...
			<tr>
				...
				<td>
					...
					<a href="<?= base_url(); ?>klien/pengiriman_data_akuntansi/pembetulan/<?=$a['id_permintaan']?>" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="bottom" title="Kirim Pembetulan">

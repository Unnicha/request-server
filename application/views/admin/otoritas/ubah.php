        ...
        <div class="row row-child my-4">
            <div class="col col-tambah">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm">
                        <input type="text" name="email" class="form-control" id="email" value="<?= $user['email_user'] ?>" required>
                        <small class="form-text text-danger">
                            <?= form_error('email', '<p class="mb-0">', '</p>') ?>
                        </small>

                        <?php if($this->session->flashdata('email_used')) : ?>
                            <small class="form-text text-danger">
                                <?= $this->session->flashdata('email_used'); ?>.
                            </small>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm">
                        ...
                        <?php if($this->session->flashdata('username_used')) : ?>
                            <small class="form-text text-danger">
                                <?= $this->session->flashdata('username_used'); ?>.
                            </small>
                        <?php endif; ?>
                    </div>
                </div>

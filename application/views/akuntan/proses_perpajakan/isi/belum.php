...
<table class="table table-sm table-striped table-bordered table-responsive-sm mb-3" id="tabelData">
		...
		<tbody class="text-center">
			...
			<tr>
				...
				<td><?= $standar ?></td>
				<td>
					<a href="<?= base_url(); ?>akuntan/proses_data_perpajakan/mulai/<?=$a['id_pengiriman']?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="bottom" title="Mulai Proses">

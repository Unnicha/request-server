        ...
        <div class="col col-tambah">
            ...
            <form action="" method="post" enctype="multipart/form-data"> 
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm">
                        <textarea name="keterangan" id="keterangan" class="form-control" placeholder="Masukkan Keterangan" value="<?= set_value('keterangan') ?>"></textarea>
                ...
                <div class="row mt-4">
                    <div class="col">
                        ...
                        <a href="<?=base_url()?>klien/permintaan_data_lainnya" name="kirim" class="btn btn-secondary">
                            Batal
                        </a>
                    </div>
                </div>

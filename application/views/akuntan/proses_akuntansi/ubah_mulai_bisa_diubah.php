            ...
            <form action="" method="post"> 
                ...
                <div class="form-group row pt-3">
                    ...
                    <div class="col-sm pr-0">
                        <input type="text" name="tanggal_mulai" class="form-control docs-date" id="tanggal_mulai" placeholder="Tanggal Mulai" data-toggle="datepicker" value="<?=$pengiriman['tanggal_mulai']?>" required>
                        <small class="form-text text-danger"><?= form_error('tanggal_mulai', '<p class="mb-0">', '</p>') ?></small>
                    </div>
                    <!-- Jam Mulai -->
                    <div class="col-sm">
                        <input type="text" name="jam_mulai" class="form-control bs-timepicker" id="jam_mulai" placeholder="Jam Mulai" value="<?=$pengiriman['jam_mulai']?>" required>

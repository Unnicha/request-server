<?php
	...
	class M_Permintaan_akuntansi extends CI_model {
		...
		public function tambahPermintaan( $data ) {
			...
			$this->db->insert('permintaan_akuntansi', $table1);
			...
			$this->db->insert_batch('data_akuntansi', $table2);
		...
		public function hapusData($id_data) {
			$this->db->delete('data_akuntansi', ['id_data' => $id_data]);
			return $this->db->affected_rows();
		}
	}
?>
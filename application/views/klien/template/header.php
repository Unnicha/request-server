<nav class="navbar navbar-dark sticky-top flex-md-nowrap p-0 shadow">
	...
	<!-- Beranda -->
	<a class="navbar-brand nav-profile col-md-3 col-lg-2 mr-0 px-3" href="<?= base_url(); ?>klien/home">
		Beranda
	</a>
	
	<button class="navbar-toggler position-absolute d-md-none collapsed" type="button" data-toggle="collapse" data-target="#sidebarMenu" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">

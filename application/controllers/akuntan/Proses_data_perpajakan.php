<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class Proses_data_perpajakan extends CI_Controller {
		...
		public function __construct() {
			...
			$this->load->model('M_Proses_perpajakan', 'MProses');
			...
			foreach($proses as $k) {
				...
				if($status == 'todo') {
					...
					$btnSelesai = ($k['id_akuntan'] != $akuntan) ? '' : '
						<a href="proses_data_perpajakan/done/'.$k['id_proses'].'" data-toggle="tooltip" data-placement="bottom" title="Selesaikan Proses">

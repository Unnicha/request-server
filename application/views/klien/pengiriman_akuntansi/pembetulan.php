		...
		<div class="col col-tambah">
			...
			<form action="" method="post" enctype="multipart/form-data"> 
				...
				<div class="form-group row">
					...
					<div class="col-sm">
						<input type="text" name="tanggal_pengiriman" class="form-control" id="tanggal_pengiriman" value="<?= date('d-m-Y H:i') ?>" readonly>
					</div>
				</div>
				...
				<div class="row mt-4">
					<div class="col">
						...
						<a href="<?=base_url()?>klien/pengiriman_data_akuntansi" name="kirim" class="btn btn-secondary">
							Batal
						</a>
					</div>
				</div>

...
<div class="modal-footer">
    <a href="<?=base_url()?>akuntan/proses_data_lainnya/ubah/<?=$proses['id_proses']?>" class="btn btn-info">
        Ubah
    </a>
    <a href="<?=base_url()?>akuntan/proses_data_lainnya/hapus/<?=$proses['id_proses']?>" class="btn btn-danger" onclick="return_confirm('Yakin ingin menghapus proses <?=$proses['jenis_data'], $proses['nama_klien']?> ?')">
        Hapus
    </a>
</div>
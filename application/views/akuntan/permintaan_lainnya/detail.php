<div class="container-fluid">
	...
	<div class="row mb-4">
		<div class="col">
			<a href="<?=base_url('akuntan/permintaan_data_lainnya')?>" class="btn btn-secondary mr-1">Kembali</a>
		</div>
	</div>
</div>
		...
		$('#konfirmShow').on('click', '.btn-fix', function() {
			...
			$.ajax({
				...
				success	: function() {
					...
					window.location.assign("<?= base_url();?>akuntan/permintaan_data_lainnya/detail/"+id);
				}
			})
		})
	})

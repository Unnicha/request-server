		...
		<tbody class="text-center">
			...
			<tr>
				...
				<td>
					...
					<a class="btn btn-sm btn-success" href="<?= base_url(); ?>klien/permintaan_data_perpajakan/kirim/<?= $a['id_permintaan']; ?>" data-toggle="tooltip" data-placement="bottom" title="Kirim Data">

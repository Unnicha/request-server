		...
		<tbody class="text-center">
			...
			<tr>
				...
				<td>
					...
					<a class="btn btn-sm btn-success" href="<?= base_url(); ?>klien/permintaan_data_akuntansi/kirim/<?= $a['id_permintaan']; ?>" data-toggle="tooltip" data-placement="bottom" title="Kirim Data">

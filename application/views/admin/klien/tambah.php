            ...
            <div class="col">
                ...
                <div class="row row-child mt-2">
                    ...
                    <div class="col-sm-12 col-lg-6">
                        ...
                        <!-- Konfirmasi Password -->
                        <div class="form-group row">
                            <label for="passconf" class="col-sm-4 col-form-label">
                                Konfirmasi
                            </label> 
                            <div class="col-sm">
                    ...
                    <div class="col-sm-12 col-lg-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col col-sm">
                                ...
                                <small class="form-text text-danger">
                                <?= form_error('kode_klu', '<p class="mb-0">', '</p>') ?>
                                </small>
                            </div>
                        </div>
                        ...
                        <!-- Jenis Usaha -->
                        <div class="form-group row">
                            <label for="jenis_usaha" class="col-sm-4 col-form-label">
                                Jenis Usaha
                            </label> 
                            <div class="col col-sm">
                    ...
                    <div class="col-sm-12 col-lg-6">
                        ...
                        <div class="row row-child mt-2">
                            <div class="col">
                                ...
                                <!-- Nama Pimpinan -->
                                <div class="form-group row">
                                    <label for="nama_pimpinan" class="col-sm-4 col-form-label">
                                        Nama
                                    </label> 
                                    <div class="col-sm">
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content" id="showModal">
                ...
                <div class="modal-header">
                    <h6 class="modal-title" id="modalLabel">Pilih Kategori Lapangan Usaha</h6>

		...
		<div class="card-body p-0">
			<div class="row px-4 pt-3">
				...
				<div class="col col-sm-3">
					<a href="<?= base_url() ?>admin/permintaan/permintaan_data_lainnya/tambah" class="btn btn-primary float-right" data-toggle="tooltip" data-placement="bottom" title="Buat permintaan baru">
...
<script>
	$(document).ready(function() { 
		...
		$('#myTable tbody').on('click', 'a.btn-hapus', function() {
			...
			$.ajax({
				type	: 'POST',
				url		: '<?= base_url(); ?>admin/permintaan/permintaan_data_lainnya/hapus',

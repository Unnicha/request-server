		...
		<div class="row mb-2">
			<div class="col">
				<p class="lead mb-0">
					...
					<a href="<?=base_url('akuntan/permintaan_data_akuntansi/edit/'.$permintaan['id_permintaan'])?>" class="btn-edit" data-toggle="tooltip" data-placement="right" title="Edit Permintaan">
